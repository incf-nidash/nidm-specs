...
def main():
    ...
    subcomponents["Acquisition"] = [NIDM['AcquisitionMethod'],NIDM['AcquisitionModality'],
        ...
        NIDM['SessionObject'] ]
    subcomponents["Modality"] = [NIDM['Amperometry'], NIDM['Anatomical'], NIDM['BlockBasedDesign'],
        ...
        NIDM['EventRelatedDesign'], NIDM['ExtracellularElectrophysiologyRecording'], 
        ...
        NIDM['MagneticResonanceImaging'], NIDM['MixedDesign'], NIDM['MultiUnitReccording'],
        NIDM['fMRIDesignType'], NIDM['NuclearMagneticResonanceSpectroscopy'], NIDM['Outside-inSpiral'],
