<h1>NIDM-Experiment Terms curation status</h1>You will find below a listing of the NIDM-Experiment terms that need to be curated. If you would like to help with the curation of a term, please follow those steps: first, check if the term is already under discussion in an \ 
...
<tr>
    <td><img src="../../../doc/content/specs/img/orange.png?raw=true"/>  </td>
    <td><a href="https://github.com/incf-nidash/nidm//issues?&q='Blood Draw'"> [find issues/PR] </a></td>
    <td><b>nidm:'Blood Draw': </b>Blood draw is an activity in which blood is removed from the body, usually for the purpose of medically-related or scientific measurements</td>
</tr>
<tr>
    <td><img src="../../../doc/content/specs/img/orange.png?raw=true"/>  </td>
...
<tr>
    <td><img src="../../../doc/content/specs/img/orange.png?raw=true"/>  </td>
    <td><a href="https://github.com/incf-nidash/nidm//issues?&q='Date'"> [find issues/PR] </a></td>
    <td><b>nidm:'Date': </b>A date is an information content entity compfising the combination of year, month, and numerical value for the day in that month that an event happened</td>
</tr>
<tr>
    <td><img src="../../../doc/content/specs/img/orange.png?raw=true"/>  </td>
...
<tr>
    <td><img src="../../../doc/content/specs/img/orange.png?raw=true"/>  </td>
    <td><a href="https://github.com/incf-nidash/nidm//issues?&q='File Path'"> [find issues/PR] </a></td>
    <td><b>nidm:'File Path': </b>A file path is the location of a file on a computer storage volume</td>
</tr>
<tr>
    <td><img src="../../../doc/content/specs/img/orange.png?raw=true"/>  </td>
...
<tr>
    <td><img src="../../../doc/content/specs/img/orange.png?raw=true"/>  </td>
    <td><a href="https://github.com/incf-nidash/nidm//issues?&q='Magnetization Transfer'"> [find issues/PR] </a></td>
    <td><b>nidm:'Magnetization Transfer': </b>Magnetization transfer is a magnetic resonance imaging acquisition method in which a radiofrequency pulse is applied off resonance (with respect to free protons)and the saturation transfer between protons bound to macromolecules and free protons is measured</td>
</tr>
<tr>
    <td><img src="../../../doc/content/specs/img/orange.png?raw=true"/>  </td>
...
<tr>
    <td><img src="../../../doc/content/specs/img/orange.png?raw=true"/>  </td>
    <td><a href="https://github.com/incf-nidash/nidm//issues?&q='Path'"> [find issues/PR] </a></td>
    <td><b>nidm:'Path': </b>A path is the location of an entity on a computer storage volume</td>
</tr>
<tr>
    <td><img src="../../../doc/content/specs/img/orange.png?raw=true"/>  </td>
...
<tr>
    <td><img src="../../../doc/content/specs/img/orange.png?raw=true"/>  </td>
    <td><a href="https://github.com/incf-nidash/nidm//issues?&q='Radioactivity'"> [find issues/PR] </a></td>
    <td><b>nidm:'Radioactivity': </b>Radioactivity is a random and spontaneous activity by which a nucleus emits alpha, beta or gamma radiation.</td>
</tr>
<tr>
    <td><img src="../../../doc/content/specs/img/orange.png?raw=true"/>  </td>
...
<tr>
    ...
    <td><b>nidm:'T2 Weighted': </b>T2 weighted is an image contrast type in which differences in voxel intensity reflect differences in the spin-spin relaxation time  of the probe in the underlying sample</td>
</tr>
<tr>
    <td><img src="../../../doc/content/specs/img/orange.png?raw=true"/>  </td>
...
<tr>
    <td><img src="../../../doc/content/specs/img/red.png?raw=true"/>  </td>
    <td>To be discussed<br/><a href="https://github.com/incf-nidash/nidm//issues?&q='had File Path'"> [find issues/PR] </a></td>
    <td><b>nidm:'had File Path': </b>Had file path is a datatype property that associates a file on a computor storage volume with the string containing the location of that file on the computer storage volume</td>
    <td></td>
    <td></td>
</tr>
<tr>
...
<tr>
    <td><img src="../../../doc/content/specs/img/red.png?raw=true"/>  </td>
    <td>To be discussed<br/><a href="https://github.com/incf-nidash/nidm//issues?&q='had Path'"> [find issues/PR] </a></td>
    <td><b>nidm:'had Path': </b>Had path is a datatype property that associates an entity on a computor storage volume with the string containing the location of that entity on the computer storage volume</td>
    <td></td>
    <td></td>
</tr>
<tr>
