...
from Constants import STATO_OLS_STR, STATO_OLS_LABEL, STATO_TSTATISTIC_STR, \
    ...
    NIDM_P_VALUE_UNCORRECTED_QNAME, OBO_STATISTIC_QNAME, NLX_MRI_SCANNER, \
    q_graph, NLX_FMRI_PROTOCOL
...
def main():
    nidm_classes = {
        ...
        "Data": dict(
            ...
            mri_protocol=NLX_FMRI_PROTOCOL,
        ...
        "CoordinateSpace-1": dict(
            ...
            voxel_to_world_mapping="[[-3, 0, 0, 81],[0, 3, 0, -115],[0, 0, 3, \
-53],[0, 0, 0, 1]]",
...
-53],[0, 0, 0, 1]]",
        ...
        "ContrastMap": dict(
            ...
            contrast_name="listening > rest",
            coordinate_space_id="niiri:coordinate_space_id_1",
            sha="400a2f07d99ed9be06577e6ecc89222cf4b688c654bc89067da558e88b73b\
97dd1b25e6c98f2a735fa0a1409598cff7e6025bda55abb6b9f5ef65d8d307eeba8",
