...
from Constants import STATO_OLS_STR, STATO_OLS_LABEL, STATO_TSTATISTIC_STR, \
    ...
    NIDM_P_VALUE_UNCORRECTED_QNAME, NLX_MRI_SCANNER, q_graph, NLX_FMRI_PROTOCOL
...
id_2",
        ...
        "StatisticMap-T": dict(
            ...
            label="T-Statistic Map: listening > reading",
        ...
        "ExtentThresholdStat_equivThresh_equivThresh2_clusterSizeResels-2":
        dict(
        ...
        "ExtentThresholdStat_equivThresh_equivThresh2_clusterSizeResels-3":
        dict(
...
df50ea84deca8de0725641a0105b712a80a0c8931df9bdf3bef788b1041379d00875",
        ...
        "ExtentThresholdStat_equivThresh_equivThresh2_clusterSizeResels-1":
        dict(
