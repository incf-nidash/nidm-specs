...
def main():
	nidm_classes = {
		...
		"FSL_ParameterEstimateMap_NoLocation-2": dict(
			...
			filename="pe2.nii.gz",
			format="image/nifti",
			coordinate_space_id="niiri:coordinate_space_id_3",
			sha="e43b6e01b0463fe7d40782137867a...",
			param_est_id="niiri:model_parameters_estimation_id"),
		"FSL_ParameterEstimateMap_NoLocation-3": dict(
			...
			filename="pe3.nii.gz",
			format="image/nifti",
			coordinate_space_id="niiri:coordinate_space_id_4",
			sha="e43b6e01b0463fe7d40782137867a...",
			param_est_id="niiri:model_parameters_estimation_id"),
		"FSL_ParameterEstimateMap_NoLocation-4": dict(
			...
			filename="pe4.nii.gz",
			format="image/nifti",
			coordinate_space_id="niiri:coordinate_space_id_5",
			sha="e43b6e01b0463fe7d40782137867a...",
			param_est_id="niiri:model_parameters_estimation_id"),
		...
		"CoordinateSpace-6": dict(
			coordinate_space_id="niiri:coordinate_space_id_6",
			label="Coordinate space 6",
			voxel_to_world_mapping="[[ -3.5, 0, 0, 108.5], [ 0, 3.5, 0, -108.5], [ 0, 0, 3.5, -52.5], [ 0, 0, 0, 1]]",
			voxel_units="['mm', 'mm', 'mm']",
			voxel_size="[3.5, 3.5, 3.5]",
			coord_system="nidm:IcbmMni152NonLinear6thGenerationCoordinateSystem",
		...
		"CoordinateSpace-7": dict(
			coordinate_space_id="niiri:coordinate_space_id_7",
			label="Coordinate space 7",
			voxel_to_world_mapping="[[ -3.5, 0, 0, 108.5], [ 0, 3.5, 0, -108.5], [ 0, 0, 3.5, -52.5], [ 0, 0, 0, 1]]",
			voxel_units="['mm', 'mm', 'mm']",
			voxel_size="[3.5, 3.5, 3.5]",
			coord_system="nidm:IcbmMni152NonLinear6thGenerationCoordinateSystem",
		...
		"CoordinateSpace-8": dict(
			coordinate_space_id="niiri:coordinate_space_id_8",
			label="Coordinate space 8",
			voxel_to_world_mapping="[[ -3.5, 0, 0, 108.5], [ 0, 3.5, 0, -108.5], [ 0, 0, 3.5, -52.5], [ 0, 0, 0, 1]]",
			voxel_units="['mm', 'mm', 'mm']",
			voxel_size="[3.5, 3.5, 3.5]",
			coord_system="nidm:IcbmMni152NonLinear6thGenerationCoordinateSystem",
		...
		"CoordinateSpace-9": dict(
			coordinate_space_id="niiri:coordinate_space_id_9",
			label="Coordinate space 9",
			voxel_to_world_mapping="[[ -3.5, 0, 0, 108.5], [ 0, 3.5, 0, -108.5], [ 0, 0, 3.5, -52.5], [ 0, 0, 0, 1]]",
			voxel_units="['mm', 'mm', 'mm']",
			voxel_size="[3.5, 3.5, 3.5]",
			coord_system="nidm:IcbmMni152NonLinear6thGenerationCoordinateSystem",
		...
		"CoordinateSpace-10": dict(
			coordinate_space_id="niiri:coordinate_space_id_10",
			label="Coordinate space 10",
			voxel_to_world_mapping="[[ -3.5, 0, 0, 108.5], [ 0, 3.5, 0, -108.5], [ 0, 0, 3.5, -52.5], [ 0, 0, 0, 1]]",
			voxel_units="['mm', 'mm', 'mm']",
			voxel_size="[3.5, 3.5, 3.5]",
			coord_system="nidm:IcbmMni152NonLinear6thGenerationCoordinateSystem",
		...
		"CoordinateSpace-11": dict(
			coordinate_space_id="niiri:coordinate_space_id_11",
			label="Coordinate space 11",
			voxel_to_world_mapping="[[ -3.5, 0, 0, 108.5], [ 0, 3.5, 0, -108.5], [ 0, 0, 3.5, -52.5], [ 0, 0, 0, 1]]",
			voxel_units="['mm', 'mm', 'mm']",
			voxel_size="[3.5, 3.5, 3.5]",
			coord_system="nidm:IcbmMni152NonLinear6thGenerationCoordinateSystem",
		...
		"CoordinateSpace-12": dict(
			coordinate_space_id="niiri:coordinate_space_id_12",
			label="Coordinate space 12",
			voxel_to_world_mapping="[[ -3.5, 0, 0, 108.5], [ 0, 3.5, 0, -108.5], [ 0, 0, 3.5, -52.5], [ 0, 0, 0, 1]]",
			voxel_units="['mm', 'mm', 'mm']",
			voxel_size="[3.5, 3.5, 3.5]",
			coord_system="nidm:IcbmMni152NonLinear6thGenerationCoordinateSystem",
		...
		"CoordinateSpace-13": dict(
			coordinate_space_id="niiri:coordinate_space_id_13",
			label="Coordinate space 13",
			voxel_to_world_mapping="[[ -3.5, 0, 0, 108.5], [ 0, 3.5, 0, -108.5], [ 0, 0, 3.5, -52.5], [ 0, 0, 0, 1]]",
			voxel_units="['mm', 'mm', 'mm']",
			voxel_size="[3.5, 3.5, 3.5]",
			coord_system="nidm:IcbmMni152NonLinear6thGenerationCoordinateSystem",
		...
		"CoordinateSpace-14": dict(
			coordinate_space_id="niiri:coordinate_space_id_14",
			label="Coordinate space 14",
			voxel_to_world_mapping="[[ -3.5, 0, 0, 108.5], [ 0, 3.5, 0, -108.5], [ 0, 0, 3.5, -52.5], [ 0, 0, 0, 1]]",
			voxel_units="['mm', 'mm', 'mm']",
			voxel_size="[3.5, 3.5, 3.5]",
			coord_system="nidm:IcbmMni152NonLinear6thGenerationCoordinateSystem",
		...
		"CoordinateSpace-15": dict(
			coordinate_space_id="niiri:coordinate_space_id_15",
			label="Coordinate space 15",
			voxel_to_world_mapping="[[ -3.5, 0, 0, 108.5], [ 0, 3.5, 0, -108.5], [ 0, 0, 3.5, -52.5], [ 0, 0, 0, 1]]",
			voxel_units="['mm', 'mm', 'mm']",
			voxel_size="[3.5, 3.5, 3.5]",
			coord_system="nidm:IcbmMni152NonLinear6thGenerationCoordinateSystem",
		...
		"FSL_ExcursionSet": dict(
			excursion_set_id="niiri:excursion_set_id_1",
			label="Excursion Set",
		...
		"FSL_Peak_NoP_MaxCluster-4-1": dict(
		...
		"FSL_Peak_NoP_MaxCluster-3-1": dict(
		...
		"FSL_Peak_NoP_MaxCluster-2-1": dict(
		...
		"FSL_Peak_NoP_MaxCluster-1-1": dict(
